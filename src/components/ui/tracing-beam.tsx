...
export const TracingBeam = ({
  ...
  const y2 = useSpring(
    useTransform(scrollYProgress, [0, 1], [80, svgHeight]),
    {
      stiffness: 500,
      damping: 90,
    }
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("relative w-full max-w-4xl mx-auto h-auto", className)}
    >
    ...
    >
          ...
          ></motion.path>
          <motion.path
            d={`M 1 0V -36 l 18 24 V ${svgHeight * 0.3} l -18 24V ${svgHeight}`}
            fill="none"
            stroke="url(#gradient)"
            strokeWidth="1.25"
